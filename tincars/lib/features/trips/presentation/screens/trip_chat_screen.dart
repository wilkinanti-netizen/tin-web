          ...
          Expanded(
            child: messagesAsync.when(
              data: (messages) {
                ...
                print(
                  'DEBUG CHAT: Recibidos ${messages.length} mensajes reales',
                );
                print(
                  'DEBUG CHAT: ${optimisticMessages.length} mensajes optimistas',
                );

                for (final optMsg in optimisticMessages) {
                  // Check if message already exists in the real stream
                  ...
                  if (!alreadyExists) {
                    print(
                      'DEBUG CHAT: Agregando mensaje optimista: ${optMsg.text}',
                    );
                    allMessages.add(optMsg);
                  }
                }
                ...
                print(
                  'DEBUG CHAT: Total mensajes a mostrar: ${allMessages.length}',
                );
                ...
                // Scroll to bottom when messages list is built
