...
/// Pantalla de calificación para el CONDUCTOR.
/// El conductor califica al pasajero al finalizar el viaje.
...
class _DriverRatingScreenState extends ConsumerState<DriverRatingScreen>
  ...
  // Chips específicos para evaluar al PASAJERO
  ...
  String get _ratedUserId => widget.trip.passengerId;
  ...
  Future<void> _submitRating() async {
    ...
    AppLogger.log(
      '[RATING][CONDUCTOR] Enviando: $_selectedRating estrellas al pasajero $_ratedUserId',
    );
    ...
    final success = await ref
        ...
        .submitRating(
          ...
          raterIsDriver: true, // El conductor califica
        );
  ...
  Widget build(BuildContext context) {
    ...
    // Watch the trip in real-time to see if a tip is added
          ...
          child: SafeArea(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                Text(
                  'Tu opinión ayuda a mantener una comunidad segura',
                  style: TextStyle(
                ...
                TextButton(
                  onPressed: ratingState.isSubmitting
                      ...
                      : () {
                          AppLogger.log(
                            '[RATING][CONDUCTOR] Omitida para viaje ${widget.trip.id}',
                          );
