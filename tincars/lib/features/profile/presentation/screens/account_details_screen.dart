        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: Text(l10n.mapAvatar),
              subtitle: Text(l10n.mapAvatarDescription),
              trailing: const Icon(Icons.chevron_right),
              onTap: () {
                // Assuming _editMapEmoji is a method that navigates or shows a dialog
                // and userProfile is accessible, which it is via widget.user
                // This part of the original instruction was syntactically incorrect
                // and has been adapted to a plausible implementation.
                // If _editMapEmoji is not defined, it would need to be added.
                // For now, let's just show a placeholder action.
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      'Edit Map Emoji: ${widget.user.mapEmoji ?? '🙋‍♂️'}',
                    ),
                  ),
                );
              },
        ...
        Row(
          children: [
            Container(
              ...
              child: Text(
                widget.user.mapEmoji ?? '🙋‍♂️',
                style: const TextStyle(fontSize: 24),
              ),
            ),
            const SizedBox(width: 16),
            const Text(
              'Este emoji te representará en el mapa.',
