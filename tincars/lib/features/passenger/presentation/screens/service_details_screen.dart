...
class ServiceDetailsScreen extends ConsumerWidget {
  ...
  const ServiceDetailsScreen({super.key, required this.vehicleType});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final pricingService = ref.watch(pricingServiceProvider);
    final name = pricingService.getVehicleName(vehicleType);
    final description = pricingService.getVehicleDescription(vehicleType);
    final capacity = pricingService.getVehicleCapacity(vehicleType);
